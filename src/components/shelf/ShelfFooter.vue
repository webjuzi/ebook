...
<!-- 书架底部菜单 -->
  <div>
    ...
    <shelf-group-dialog
      :visible.sync="ifGroupDialogShow">
    </shelf-group-dialog>
  </div>
</template>
    ...
    downloadBook(book) {
      ...
      return new Promise((resolve, reject) => {
        download(book, book => {
          ...
          const progress = Math.floor(progressEvent.loaded / 1024 / 1024 * 100) / 100 + 'M'
...
<style lang="scss" rel="setlesheet/scss" scoped>
...
.shelf-tooter{
  ...
  box-shadow: 0 px2rem(-2) px2rem(4) 0 rgba(0, 0, 0, .2);
